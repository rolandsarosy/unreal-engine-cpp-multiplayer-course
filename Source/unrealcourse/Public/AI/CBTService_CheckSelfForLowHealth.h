...
protected:
	...
	UPROPERTY(EditAnywhere, Category="AI",
		meta=(ClampMin = "1", ClampMax = "99", Tooltip =
			"The health percentage (inclusive, between 0-100) breakpoint that'll determine where the AI entity is considered to be critically low on health."))
