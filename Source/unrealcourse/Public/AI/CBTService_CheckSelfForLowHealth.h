...
protected:
	...
	UPROPERTY(EditAnywhere, Category="AI", meta=(Tooltip = "The health percentage (inclusive, between 0-100) breakpoint that'll determine where the AI entity is considered to be critically low on health."))
